...
const $$Phtable = createComponent(async ($$result, $$props, $$slots) => {
...
}, "D:/0 to hero/astro js/FieldIQ/src/pages/ph/phtable.astro", void 0);

const $$file = "D:/0 to hero/astro js/FieldIQ/src/pages/ph/phtable.astro";
const $$url = "/ph/phtable";

export { $$Phtable as default, $$file as file, $$url as url };
