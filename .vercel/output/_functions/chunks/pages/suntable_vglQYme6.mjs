...
const $$Suntable = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Suntable;
  let searchQuery = "";
...
}, "D:/0 to hero/astro js/FieldIQ/src/pages/sun/suntable.astro", void 0);

const $$file = "D:/0 to hero/astro js/FieldIQ/src/pages/sun/suntable.astro";
const $$url = "/sun/suntable";

export { $$Suntable as default, $$file as file, $$url as url };
