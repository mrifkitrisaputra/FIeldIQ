...
const $$Temptable = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Temptable;
  let searchQuery = "";
...
}, "D:/0 to hero/astro js/FieldIQ/src/pages/temp/temptable.astro", void 0);

const $$file = "D:/0 to hero/astro js/FieldIQ/src/pages/temp/temptable.astro";
const $$url = "/temp/temptable";

export { $$Temptable as default, $$file as file, $$url as url };
