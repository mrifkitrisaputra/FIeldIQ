import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, k as renderSlot, g as renderComponent, e as renderHead, f as addAttribute } from '../astro_3fiXy-ut.mjs';
import { $ as $$ViewTransitions, a as $$Content } from './content_DAhiEB4r.mjs';
/* empty css                          */
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Image } from './generic_CEpaMEha.mjs';
import $$Humidtable from './humidtable_BuymB6zf.mjs';
import $$Phtable from './phtable_CAt0ArDx.mjs';
import $$Tabledata from './Tabledata_Babq5r9C.mjs';
import $$Suntable from './suntable_vglQYme6.mjs';
import $$Temptable from './temptable_D_Yi_u2h.mjs';
import 'clsx';
import $$Usertable from './usertable_DS0zUUsd.mjs';
/* empty css                          */
